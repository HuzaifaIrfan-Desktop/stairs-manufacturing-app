...
class StraightSawtoothStringerStandardStairsJob(Job):
    ...
    def _assemble(self):
        assembly_object = self.standard_stairs_assembly.get().val()
        ...
        top_floor_opening_params = TopFloorOpeningParams(
            ...
            opening_length=self.standard_stairs_assembly_params.total_assembly_run_depth,
    ...
    def export_drawings(self) -> str:
        ...
        file_path = self.standard_stairs_assembly.export_drawings()
        return file_path
    
    def export_reports(self) -> str:
        # Export the assembly to a file
        file_path = self.standard_stairs_assembly.export_reports()
        return file_path
    

    def export_cam(self) -> str:
        # Export the assembly to a file
        file_path = self.standard_stairs_assembly.export_cam()
        return file_path