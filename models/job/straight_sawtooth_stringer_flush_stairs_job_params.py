...
class StraightSawtoothStringerFlushStairsJobInputParams(JobInputParams):
...
class StraightSawtoothStringerFlushStairsJobOutputParams(StraightSawtoothStringerFlushStairsJobInputParams):


    flush_stairs_assembly_params:StraightSawtoothStringerFlushStairsAssemblyParams = Field(init=False, default=None, validate_default=False, description="Flush stairs assembly parameters")
