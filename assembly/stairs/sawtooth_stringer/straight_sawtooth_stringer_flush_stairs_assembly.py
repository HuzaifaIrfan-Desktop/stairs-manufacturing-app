...
class StraightSawtoothStringerFlushStairsAssembly(Assembly):
    ...
    def export_cut_list(self) -> str:
        ...
        cut_list_data.append( ["Typical Treads", self.assembly_params.number_of_steps-1, self.typical_tread_params.tread_material.material_name, f"{float_to_mixed_fraction(self.typical_tread_params.tread_depth)} x {float_to_mixed_fraction(self.typical_tread_params.tread_length)}"])
        ...
        if not self.assembly_params.open_riser:
            ...
            cut_list_data.append( ["Typical Risers", self.assembly_params.number_of_steps-1, self.typical_riser_params.riser_material.material_name, f"{float_to_mixed_fraction(self.typical_riser_params.riser_height)} x {float_to_mixed_fraction(self.typical_riser_params.riser_length)}"])
